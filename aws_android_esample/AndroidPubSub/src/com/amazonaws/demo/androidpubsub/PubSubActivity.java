...
public class PubSubActivity extends Activity {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a149rrr3aom64u.iot.us-west-2.amazonaws.com";
    // Cognito pool ID. For this app, pool needs to be unauthenticated pool with
    // AWS IoT permissions.
    private static final String COGNITO_POOL_ID = "us-west-2:f8efb03b-1de7-45b6-a96d-49a807133bf5";
    // Name of the AWS IoT policy to attach to a newly created certificate
    private static final String AWS_IOT_POLICY_NAME = "pmlAppPolicy3";
